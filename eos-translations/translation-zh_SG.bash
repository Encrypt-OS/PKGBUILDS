...
_tr_add2 after_install_ew      "Encrypt-OS 预设桌面背景"      # was: "Encrypt-OS wallpaper"
...
_tr_add2 cal_info2              "<b>离线</b>安装只支援Xfce桌面环境，并配以Encrypt-OS主题。\n此安装方法不需要网路连接。\n\n"
...
_tr_add2 ins_text              "在硬碟上安装Encrypt-OS"
...
_tr_add2 after_install_themedef     "Encrypt-OS的预设Xfce主题"
_tr_add2 after_install_themedeftip  "使用Encrypt-OS的预设Xfce主题"
...
# 2020-Sep-11:
_tr_add2 after_install_ew2        "选择Encrypt-OS桌面背景"   # was: "Encrypt-OS wallpaper (choose)"
_tr_add2 after_install_ewtip2     "选择桌面背景"                          # was: "Choose from Encrypt-OS default wallpapers"
