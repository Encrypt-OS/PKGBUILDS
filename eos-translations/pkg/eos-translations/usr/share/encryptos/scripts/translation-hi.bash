...
_tr_add2 after_install_ew      "एंडेवर ओएस डिफ़ॉल्ट वॉलपेपर"      # was: " wallpaper"
...
# 2020-Sep-11:
_tr_add2 after_install_ew2        "एंडेवर ओएस के वॉलपेपर्स में से चुनें"   # was: " wallpaper (choose)"
_tr_add2 after_install_ewtip2     "वॉलपेपर चुनें"                          # was: "Choose from  default wallpapers"
