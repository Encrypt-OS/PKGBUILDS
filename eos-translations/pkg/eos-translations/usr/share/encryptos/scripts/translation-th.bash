...
_tr_add2 after_install_etl     " to latest$_question"
_tr_add2 after_install_etltip  "แสดงสิ่งที่ต้องทำเพื่อให้ระบบของคุณไปถึงระดับล่าสุดของ "

_tr_add2 after_install_cdm     "เปลี่ยน display manager"
_tr_add2 after_install_cdmtip  "เปลี่ยนไปใช้ display mananer ตัวอื่น"

_tr_add2 after_install_ew      "ใช้ภาพพื้นหลังของ "      # was: " wallpaper"
_tr_add2 after_install_ewtip   "เปลี่ยนกลับไปใช้ภาพพื้นหลังเริ่มแรกของ "     # was: "Change desktop wallpaper to EOS default"
...
_tr_add2 general_info_text     "ไปที่เว็บของ $_exclamation"
...
_tr_add2 general_info_dotip    "ช่วยให้พวกเราพัฒนา  ต่อไปได้"
...
_tr_add2 cal_info2              "วิธีการแบบ <b>Offline</b> จะติดตั้ง Xfce พร้อมด้วยธีมของ \nไม่จำเป็นต้องมีการเชื่อมต่ออินเทอร์เน็ต\n\n"
...
_tr_add2 ins_text              "กำลังติดตั้ง  ลงดิสก์"
...
_tr_add2 after_install_themedef     "ใช้ธีม Xfce ของ "
_tr_add2 after_install_themedeftip  "ใช้ธีม Xfce เริ่มต้นจาก "
...
# 2020-Sep-11:
_tr_add2 after_install_ew2        "เลือกวอร์เปเปอร์ของ "   # was: " wallpaper (choose)"
_tr_add2 after_install_ewtip2     "โปรแกรมเลือกวอร์เปเปอร์"                          # was: "Choose from  default wallpapers"
