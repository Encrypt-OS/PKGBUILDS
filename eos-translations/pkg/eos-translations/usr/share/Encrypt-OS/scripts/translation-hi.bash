...
_tr_add2 after_install_ew      "एंडेवर ओएस डिफ़ॉल्ट वॉलपेपर"      # was: "Encrypt-OS wallpaper"
...
# 2020-Sep-11:
_tr_add2 after_install_ew2        "एंडेवर ओएस के वॉलपेपर्स में से चुनें"   # was: "Encrypt-OS wallpaper (choose)"
_tr_add2 after_install_ewtip2     "वॉलपेपर चुनें"                          # was: "Choose from Encrypt-OS default wallpapers"
