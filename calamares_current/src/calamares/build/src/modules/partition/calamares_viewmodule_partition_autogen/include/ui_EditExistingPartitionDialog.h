...
public:
    ...
    void setupUi(QDialog *EditExistingPartitionDialog)
    {
        ...
        formLayout->setWidget(10, QFormLayout::FieldRole, m_listFlags);
        ...
        formLayout->setWidget(8, QFormLayout::FieldRole, fileSystemLabelEdit);
        ...
        formLayout->setWidget(8, QFormLayout::LabelRole, fileSystemLabelLabel);
        ...
        formLayout->setWidget(7, QFormLayout::FieldRole, mountPointExplanation);
